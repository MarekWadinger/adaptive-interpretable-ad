...
\title{Adaptable and Interpretable Framework for Anomaly Detection in SCADA-based IoT Systems}  % \tnoteref{label1}}
%% \tnotetext[label1]{}
\author[aff1,aff2]{Marek Wadinger\corref{cor1}}  % \fnref{label2}}
...
\affiliation[aff2]{organization={Tesla 50Hz s.r.o.}
}
%% \fntext[label3]{}
