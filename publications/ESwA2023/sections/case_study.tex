...
\begin{figure}[htbp]
 ...
 \caption{\added{Detection of anomalies using model \textbf{with} adaptation to change points from Figure~\ref{fig:terra_change} with added depiction of accompanying task of sampling anomaly detection (green bars). Zoomed areas focus on short events of abnormal sampling detected by AID. The second zoomed area also highlights faulty measurement, which the system marked as a point anomaly.}}
