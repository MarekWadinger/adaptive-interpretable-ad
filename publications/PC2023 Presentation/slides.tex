        ...
        \begin{tikzpicture}
            ...
            \only<1-2>{
                ...
                \only<2>{
                    ...
                    \draw[-latex, signal] (Control-b) -- (Broker-b) node [pos=0.5,below=0.2cm] {$u$};
                }
            }
            \only<3->{
            ...
            \only<4>{
                ...
                \draw[-latex, signal] (Control-b) -- (Broker-b) node [pos=0.5,below=0.2cm] {$u^{\color{red}{*}}$};
            }
            \only<3->{
...
\begin{frame}
    ...
    \begin{table}[htbp]
        ...
        \end{center}
    \end{table}
    \blfootnote{\tiny M. Wadinger and M. Kvasnica. Adaptable and interpretable framework for novelty detection in real-time iot systems. IEEE CDC 2023. (under review)}
\end{frame}
