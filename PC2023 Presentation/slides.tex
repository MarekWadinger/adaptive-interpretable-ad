...
\begin{frame}{Self-Supervised Learning}
    \begin{figure}
        \begin{center}
            \includegraphics[width=0.87\linewidth]{/Users/marekwadinger/PyProjects/river/ilustrate/welford_unstable.pdf}
        \end{center}
    \end{figure}
    \begin{subnumcases}{y_i =}
        0 & $\text{ if } q \leq F_{X}(x_i; \bar x_n, s_n)$ \label{}\tag{\ref{case:normal}}
        \\
        1 & $\text{ if } q > F_{X}(x_i; \bar x_n, s_n)$ \label{}\tag{\ref{case:anomaly}}
    \end{subnumcases}
\end{frame}
